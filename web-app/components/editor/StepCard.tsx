...
export default function StepCard({ step, stepNumber, onUpdate, onDelete }: StepCardProps) {
      ...
      <Card animate className="overflow-hidden">
        ...
        <div className="flex items-center gap-3 px-4 pt-4 pb-2">
          ...
          <input
            ...
            className="flex-1 font-heading font-medium text-base text-text-primary bg-transparent border-none outline-none focus:ring-0 placeholder:text-text-muted"
        ...
        <div className="px-4 pb-4">
          <textarea
            ...
            rows={1}
            className="w-full resize-none bg-transparent text-sm text-text-secondary placeholder:text-text-muted border-none outline-none focus:ring-0 overflow-hidden"
          />
        </div>
      </Card>
    </div>
